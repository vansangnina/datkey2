...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	    <li><a href="index.php?com=about&act=capnhat&type=<?=$type?>"><span>Nội dung</span></a></li>
...
<form name="supplier" id="validate" class="form" action="index.php?com=about&act=save&type=<?=$type?>" method="post" enctype="multipart/form-data">
	<div class="widget">
